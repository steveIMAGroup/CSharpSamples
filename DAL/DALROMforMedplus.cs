...
namespace Cyramedx.PatientForms.DAL
{
    ...
    public class DALROMforMedplus:IDisposable
    {
        ...
        public int SavePageasXML1(entROMforMedplus objEntity, Guid PatientSchedulesId)
        {
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (v == "i")
                    {
                        objPatientPage.PatientFormId = Guid.Parse("EA21118E-A7DB-43C8-AC2D-D3B77FD3935E");

                    }
                    else if (v == "p")
                    {
                        objPatientPage.PatientFormId = Guid.Parse("8B6EE2C4-6F5F-4075-98C0-9EF379E25645");
                    }
                    else
                    {
                        objPatientPage.PatientFormId = Guid.Parse("C233B77F-3A44-489F-8C68-F57B8A01BF1E");
                    }
  ...
  new XElement("numROMUpperExtremityShoulderFlexionRight", objEntity.numROMUpperExtremityShoulderFlexionRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMUpperExtremityShoulderFlexionLeft", objEntity.numROMUpperExtremityShoulderFlexionLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMUpperExtremityShoulderExtensionRight", objEntity.numROMUpperExtremityShoulderExtensionRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMUpperExtremityShoulderExtensionLeft", objEntity.numROMUpperExtremityShoulderExtensionLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  ...
  new XElement("chkHandThumbROMWNL", objEntity.chkHandThumbROMWNL, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbAdductionCMCJointRight", objEntity.numROMHandThumbAdductionCMCJointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbAdductionCMCJointLeft", objEntity.numROMHandThumbAdductionCMCJointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandThumbDefNo", objEntity.chkUEHandThumbDefNo, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandThumbDefYes", objEntity.chkUEHandThumbDefYes, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("txtUEHandThumbDef", objEntity.txtUEHandThumbDef, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbAbductionCMCJointRight", objEntity.numROMHandThumbAbductionCMCJointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbAbductionCMCJointLeft", objEntity.numROMHandThumbAbductionCMCJointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbFlexionMCPjointRight", objEntity.numROMHandThumbFlexionMCPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbFlexionMCPjointLeft", objEntity.numROMHandThumbFlexionMCPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbFlexionIPjointRight", objEntity.numROMHandThumbFlexionIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandThumbFlexionIPjointLeft", objEntity.numROMHandThumbFlexionIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkHandIndexROMWNL", objEntity.chkHandIndexROMWNL, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandIndexFlexionMCPjointRight", objEntity.numROMHandIndexFlexionMCPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandIndexFlexionMCPjointLeft", objEntity.numROMHandIndexFlexionMCPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandIndexDefNo", objEntity.chkUEHandIndexDefNo, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandIndexDefYes", objEntity.chkUEHandIndexDefYes, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("txtUEHandIndexDef", objEntity.txtUEHandIndexDef, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandIndexFlexionPIPJointRight", objEntity.numROMHandIndexFlexionPIPJointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandIndexFlexionPIPJointLeft", objEntity.numROMHandIndexFlexionPIPJointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandIndexFlexionDIPjointRight", objEntity.numROMHandIndexFlexionDIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandIndexFlexionDIPjointLeft", objEntity.numROMHandIndexFlexionDIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkHandMiddleROMWNL", objEntity.chkHandMiddleROMWNL, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandMiddleFlexionMCPjointRight", objEntity.numROMHandMiddleFlexionMCPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandMiddleFlexionMCPjointLeft", objEntity.numROMHandMiddleFlexionMCPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandMiddleDefNo", objEntity.chkUEHandMiddleDefNo, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandMiddleDefYes", objEntity.chkUEHandMiddleDefYes, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("txtUEHandMiddleDef", objEntity.txtUEHandMiddleDef, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandMiddleFlexionPIPjointRight", objEntity.numROMHandMiddleFlexionPIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandMiddleFlexionPIPjointLeft", objEntity.numROMHandMiddleFlexionPIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandMiddleFlexionDIPjointRight", objEntity.numROMHandMiddleFlexionDIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandMiddleFlexionDIPjointLeft", objEntity.numROMHandMiddleFlexionDIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkHandRingROMWNL", objEntity.chkHandRingROMWNL, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandRingFlexionMCPjointRight", objEntity.numROMHandRingFlexionMCPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandRingFlexionMCPjointLeft", objEntity.numROMHandRingFlexionMCPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandRingDefNo", objEntity.chkUEHandRingDefNo, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandRingDefYes", objEntity.chkUEHandRingDefYes, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("txtUEHandRingDef", objEntity.txtUEHandRingDef, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandRingFlexionPIPjointRight", objEntity.numROMHandRingFlexionPIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandRingFlexionPIPjointLeft", objEntity.numROMHandRingFlexionPIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandRingFlexionDIPjointRight", objEntity.numROMHandRingFlexionDIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandRingFlexionDIPjointLeft", objEntity.numROMHandRingFlexionDIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkHandLittleROMWNL", objEntity.chkHandLittleROMWNL, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandLittleFlexionMCPjointRight", objEntity.numROMHandLittleFlexionMCPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandLittleFlexionMCPjointLeft", objEntity.numROMHandLittleFlexionMCPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandLittleDefNo", objEntity.chkUEHandLittleDefNo, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkUEHandLittleDefYes", objEntity.chkUEHandLittleDefYes, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("txtUEHandLittleDef", objEntity.txtUEHandLittleDef, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandLittleFlexionPIPjointRight", objEntity.numROMHandLittleFlexionPIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandLittleFlexionPIPjointLeft", objEntity.numROMHandLittleFlexionPIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandLittleFlexionDIPjointRight", objEntity.numROMHandLittleFlexionDIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMHandLittleFlexionDIPjointLeft", objEntity.numROMHandLittleFlexionDIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  ...
  new XElement("chkHalluxROMWNL", objEntity.chkHalluxROMWNL, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMLowerExtremityHalluxDorsiflexionMTPjointRight", objEntity.numROMLowerExtremityHalluxDorsiflexionMTPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMLowerExtremityHalluxDorsiflexionMTPjointLeft", objEntity.numROMLowerExtremityHalluxDorsiflexionMTPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkLEHalluxDorsiflexionMTPjointDefNo", objEntity.chkLEHalluxDorsiflexionMTPjointDefNo, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("chkLEHalluxDorsiflexionMTPjointDefYes", objEntity.chkLEHalluxDorsiflexionMTPjointDefYes, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("txtLEHalluxDorsiflexionMTPjointDef", objEntity.txtLEHalluxDorsiflexionMTPjointDef, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMLowerExtremityHalluxPlantarFlexionMTPjointRight", objEntity.numROMLowerExtremityHalluxPlantarFlexionMTPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMLowerExtremityHalluxPlantarFlexionMTPjointLeft", objEntity.numROMLowerExtremityHalluxPlantarFlexionMTPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMLowerExtremityHalluxFlexionIPjointRight", objEntity.numROMLowerExtremityHalluxFlexionIPjointRight, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE)),
  new XElement("numROMLowerExtremityHalluxFlexionIPjointLeft", objEntity.numROMLowerExtremityHalluxFlexionIPjointLeft, new XAttribute(DATA_INHERITANCE, NOT_INHERITANCE))
                ...
                if (objPatientPage != null)
                {
                    ...
                    else
                    {
                        ...
                        if (objPatientPage.PatientFormId == Guid.Parse("EA21118E-A7DB-43C8-AC2D-D3B77FD3935E"))
                        {
                            // sqlcmd.Parameters.AddWithValue("@seq", 17);
                            sqlcmd.Parameters.AddWithValue("@seq", 18);
                        }
                        else if (objPatientPage.PatientFormId == Guid.Parse("C233B77F-3A44-489F-8C68-F57B8A01BF1E"))
                        {
